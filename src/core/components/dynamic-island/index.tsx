...
import { isNotNull, isNull, randomId, wait } from '@lib/shared'
import { AppSubscribeEvent, useAppStore } from '@core/store'
...
export default function DynamicIsland() {
  ...
  const [provider, downloadProgress, activate, deactivate, setDownloadProgress] = useAppStore(
    useShallow(state => [state.provider, state.downloadProgress, state.activate, state.deactivate, state.setDownloadProgress]),
  )
  ...
  useEffect(() => {
    const handleTranslate = (event: AppSubscribeEvent<'translate'>) => {
  ...
  useEffect(() => {
    const handleTranslatorProgress = (event: AppSubscribeEvent<'translator-progress'>) => {
